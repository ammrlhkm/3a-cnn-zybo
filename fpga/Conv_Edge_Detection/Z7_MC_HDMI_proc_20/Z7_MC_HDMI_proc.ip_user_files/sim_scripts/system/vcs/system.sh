...
#
# Generated by Vivado on Thu Dec 18 20:24:49 CET 2025
...
# Design libraries
design_libs=(xilinx_vip xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_8 processing_system7_vip_v1_0_10 xil_defaultlib xlconstant_v1_1_7)
...
compile()
{
  ...
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../Z7_MC_HDMI_proc.srcs/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../Z7_MC_HDMI_proc.srcs/sources_1/bd/system/ipshared/34f8/hdl" +incdir+"$ref_dir/../../../../Z7_MC_HDMI_proc.srcs/sources_1/bd/system/ipshared/d0f7" +incdir+"/tools/Xilinx/Vivado/2020.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../Z7_MC_HDMI_proc.srcs/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../Z7_MC_HDMI_proc.srcs/sources_1/bd/system/ipshared/34f8/hdl" +incdir+"$ref_dir/../../../../Z7_MC_HDMI_proc.srcs/sources_1/bd/system/ipshared/d0f7" +incdir+"/tools/Xilinx/Vivado/2020.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../Z7_MC_HDMI_proc.srcs/sources_1/bd/system/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work axi_vip_v1_1_8 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../Z7_MC_HDMI_proc.srcs/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../Z7_MC_HDMI_proc.srcs/sources_1/bd/system/ipshared/34f8/hdl" +incdir+"$ref_dir/../../../../Z7_MC_HDMI_proc.srcs/sources_1/bd/system/ipshared/d0f7" +incdir+"/tools/Xilinx/Vivado/2020.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../Z7_MC_HDMI_proc.srcs/sources_1/bd/system/ipshared/94c3/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a vlogan.log

  vlogan -work processing_system7_vip_v1_0_10 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../Z7_MC_HDMI_proc.srcs/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../Z7_MC_HDMI_proc.srcs/sources_1/bd/system/ipshared/34f8/hdl" +incdir+"$ref_dir/../../../../Z7_MC_HDMI_proc.srcs/sources_1/bd/system/ipshared/d0f7" +incdir+"/tools/Xilinx/Vivado/2020.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../Z7_MC_HDMI_proc.srcs/sources_1/bd/system/ipshared/34f8/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a vlogan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/system/ipshared/99c2/src/MC_HDMI_proc.vhd" \
    "$ref_dir/../../../bd/system/ip/system_MC_HDMI_proc_0_0/sim/system_MC_HDMI_proc_0_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vlogan -work xlconstant_v1_1_7 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../Z7_MC_HDMI_proc.srcs/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../Z7_MC_HDMI_proc.srcs/sources_1/bd/system/ipshared/34f8/hdl" +incdir+"$ref_dir/../../../../Z7_MC_HDMI_proc.srcs/sources_1/bd/system/ipshared/d0f7" +incdir+"/tools/Xilinx/Vivado/2020.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../Z7_MC_HDMI_proc.srcs/sources_1/bd/system/ipshared/fcfc/hdl/xlconstant_v1_1_vl_rfs.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/ammrlhkm/3a-cnn-zybo/fpga/Conv_Edge_Detection/Z7_MC_HDMI_proc_20/Z7_MC_HDMI_proc.cache/compile_simlib/vcs"
  fi
