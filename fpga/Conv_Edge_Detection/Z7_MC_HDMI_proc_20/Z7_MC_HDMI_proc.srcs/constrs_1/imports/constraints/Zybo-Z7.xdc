...
##Clock signal
set_property -dict { PACKAGE_PIN K17   IOSTANDARD LVCMOS33 } [get_ports { pl_clk}]; #IO_L12P_T1_MRCC_35 Sch=sysclk
...
set_property -dict { PACKAGE_PIN H17   IOSTANDARD TMDS_33     } [get_ports { hdmi_TMDS_Clk_n }]; #IO_L13N_T2_MRCC_35 Sch=hdmi_tx_CLK_N
set_property -dict { PACKAGE_PIN H16   IOSTANDARD TMDS_33     } [get_ports { hdmi_TMDS_Clk_p }]; #IO_L13P_T2_MRCC_35 Sch=hdmi_tx_clk_p
set_property -dict { PACKAGE_PIN D20   IOSTANDARD TMDS_33     } [get_ports { hdmi_TMDS_Data_n[0] }]; #IO_L4N_T0_35 Sch=hdmi_tx_n[0]
set_property -dict { PACKAGE_PIN D19   IOSTANDARD TMDS_33     } [get_ports { hdmi_TMDS_Data_p[0] }]; #IO_L4P_T0_35 Sch=hdmi_tx_p[0]
set_property -dict { PACKAGE_PIN B20   IOSTANDARD TMDS_33     } [get_ports { hdmi_TMDS_Data_n[1] }]; #IO_L1N_T0_AD0N_35 Sch=hdmi_tx_n[1]
set_property -dict { PACKAGE_PIN C20   IOSTANDARD TMDS_33     } [get_ports { hdmi_TMDS_Data_p[1] }]; #IO_L1P_T0_AD0P_35 Sch=hdmi_tx_p[1]
set_property -dict { PACKAGE_PIN A20   IOSTANDARD TMDS_33     } [get_ports { hdmi_TMDS_Data_n[2] }]; #IO_L2N_T0_AD8N_35 Sch=hdmi_tx_n[2]
set_property -dict { PACKAGE_PIN B19   IOSTANDARD TMDS_33     } [get_ports { hdmi_TMDS_Data_p[2] }]; #IO_L2P_T0_AD8P_35 Sch=hdmi_tx_p[2]
...
set clk_50 0;
if { $clk_50 == 1} {
create_clock -period 50 -name D_PHY_CLK_P  [get_ports D_PHY_CLK_P];

set_input_delay -clock D_PHY_CLK_P -min -7   [get_ports D_PHY_DATA_N[0]];
set_input_delay -clock D_PHY_CLK_P -max -5   [get_ports D_PHY_DATA_N[0]] ;
set_input_delay -clock D_PHY_CLK_P -min -7   [get_ports D_PHY_DATA_P[0]] ;
set_input_delay -clock D_PHY_CLK_P -max -5   [get_ports D_PHY_DATA_P[0]] ;

set_input_delay -clock D_PHY_CLK_P  -min -7  [get_ports D_PHY_DATA_P[0]] -clock_fall -add_delay;
set_input_delay -clock D_PHY_CLK_P  -max -5  [get_ports D_PHY_DATA_P[0]] -clock_fall -add_delay;

set_input_delay -clock D_PHY_CLK_P  -min -7  [get_ports D_PHY_DATA_N[0]] -clock_fall -add_delay;
set_input_delay -clock D_PHY_CLK_P  -max -5  [get_ports D_PHY_DATA_N[0]] -clock_fall -add_delay;


set_input_delay -clock D_PHY_CLK_P  -min -7  [get_ports D_PHY_DATA_P[1]];
set_input_delay -clock D_PHY_CLK_P  -max -5  [get_ports D_PHY_DATA_P[1]];

set_input_delay -clock D_PHY_CLK_P  -min -7  [get_ports D_PHY_DATA_N[1]];
set_input_delay -clock D_PHY_CLK_P  -max -5  [get_ports D_PHY_DATA_N[1]];

set_input_delay -clock D_PHY_CLK_P  -min -7  [get_ports D_PHY_DATA_P[1]] -clock_fall -add_delay;
set_input_delay -clock D_PHY_CLK_P  -max -5  [get_ports D_PHY_DATA_P[1]] -clock_fall -add_delay;

set_input_delay -clock D_PHY_CLK_P  -min -7  [get_ports D_PHY_DATA_N[1]] -clock_fall -add_delay;
set_input_delay -clock D_PHY_CLK_P  -max -5  [get_ports D_PHY_DATA_N[1]] -clock_fall -add_delay;
}


create_clock -period 8 -name D_PHY_CLK_P  [get_ports D_PHY_CLK_P];

set_input_delay -clock D_PHY_CLK_P -min -3   [get_ports D_PHY_DATA_N[0]];
set_input_delay -clock D_PHY_CLK_P -max -1   [get_ports D_PHY_DATA_N[0]] ;
set_input_delay -clock D_PHY_CLK_P -min -3   [get_ports D_PHY_DATA_P[0]] ;
set_input_delay -clock D_PHY_CLK_P -max -1   [get_ports D_PHY_DATA_P[0]] ;

set_input_delay -clock D_PHY_CLK_P  -min -3 [get_ports D_PHY_DATA_P[0]] -clock_fall -add_delay;
set_input_delay -clock D_PHY_CLK_P  -max -1  [get_ports D_PHY_DATA_P[0]] -clock_fall -add_delay;

set_input_delay -clock D_PHY_CLK_P  -min -3 [get_ports D_PHY_DATA_N[0]] -clock_fall -add_delay;
set_input_delay -clock D_PHY_CLK_P  -max -1  [get_ports D_PHY_DATA_N[0]] -clock_fall -add_delay;


set_input_delay -clock D_PHY_CLK_P  -min -3  [get_ports D_PHY_DATA_N[1]];
set_input_delay -clock D_PHY_CLK_P  -max -1  [get_ports D_PHY_DATA_N[1]];

set_input_delay -clock D_PHY_CLK_P  -min -3  [get_ports D_PHY_DATA_P[1]];
set_input_delay -clock D_PHY_CLK_P  -max -1  [get_ports D_PHY_DATA_P[1]];

set_input_delay -clock D_PHY_CLK_P  -min -3  [get_ports D_PHY_DATA_P[1]] -clock_fall -add_delay;
set_input_delay -clock D_PHY_CLK_P  -max -1  [get_ports D_PHY_DATA_P[1]] -clock_fall -add_delay;

set_input_delay -clock D_PHY_CLK_P  -min -3  [get_ports D_PHY_DATA_N[1]] -clock_fall -add_delay;
set_input_delay -clock D_PHY_CLK_P  -max -1  [get_ports D_PHY_DATA_N[1]] -clock_fall -add_delay;


set_property INTERNAL_VREF 0.6 [get_iobanks 35];
set_property -dict { PACKAGE_PIN J19   IOSTANDARD HSUL_12     } [get_ports { D_PHY_LP_CLK_N }]; #IO_L10N_T1_AD11N_35 Sch=lp_CLK_N
set_property -dict { PACKAGE_PIN H20   IOSTANDARD HSUL_12     } [get_ports { D_PHY_LP_CLK_P }]; #IO_L17N_T2_AD5N_35 Sch=lp_CLK_P
set_property -dict { PACKAGE_PIN M18   IOSTANDARD HSUL_12     } [get_ports { D_PHY_LP_DATA_N[0] }]; #IO_L8N_T1_AD10N_35 Sch=lp_lane_n[0]
set_property -dict { PACKAGE_PIN L19   IOSTANDARD HSUL_12     } [get_ports { D_PHY_LP_DATA_P[0] }]; #IO_L9P_T1_DQS_AD3P_35 Sch=lp_lane_p[0]
set_property -dict { PACKAGE_PIN L20   IOSTANDARD HSUL_12     } [get_ports { D_PHY_LP_DATA_N[1] }]; #IO_L9N_T1_DQS_AD3N_35 Sch=lp_lane_n[1]
set_property -dict { PACKAGE_PIN J20   IOSTANDARD HSUL_12     } [get_ports { D_PHY_LP_DATA_P[1] }]; #IO_L17P_T2_AD5P_35 Sch=lp_lane_p[1]
set_property -dict { PACKAGE_PIN H18   IOSTANDARD MINI_LVDS_25     } [get_ports { D_PHY_CLK_N }]; #IO_L14N_T2_AD4N_SRCC_35 Sch=mipi_CLK_N
set_property -dict { PACKAGE_PIN J18   IOSTANDARD MINI_LVDS_25     } [get_ports { D_PHY_CLK_P }]; #IO_L14P_T2_AD4P_SRCC_35 Sch=mipi_CLK_P
set_property -dict { PACKAGE_PIN M20   IOSTANDARD MINI_LVDS_25     } [get_ports { D_PHY_DATA_N[0] }]; #IO_L7N_T1_AD2N_35 Sch=mipi_lane_n[0]
set_property -dict { PACKAGE_PIN M19   IOSTANDARD MINI_LVDS_25     } [get_ports { D_PHY_DATA_P[0] }]; #IO_L7P_T1_AD2P_35 Sch=mipi_lane_p[0]
set_property -dict { PACKAGE_PIN L17   IOSTANDARD MINI_LVDS_25     } [get_ports { D_PHY_DATA_N[1] }]; #IO_L11N_T1_SRCC_35 Sch=mipi_lane_n[1]
set_property -dict { PACKAGE_PIN L16   IOSTANDARD MINI_LVDS_25     } [get_ports { D_PHY_DATA_P[1] }]; #IO_L11P_T1_SRCC_35 Sch=mipi_lane_p[1]
