...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net processing_system7_1_M_AXI_GP0 [get_bd_intf_pins processing_system7_1/M_AXI_GP0] [get_bd_intf_pins smartconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins axi_Z7_ProcHDMI_0/s00_axi] [get_bd_intf_pins smartconnect_0/M00_AXI]

  # Create port connections
  connect_bd_net -net axi_Z7_ProcHDMI_0_hdmi_TMDS_Clk_n [get_bd_ports hdmi_TMDS_Clk_n] [get_bd_pins axi_Z7_ProcHDMI_0/hdmi_TMDS_Clk_n]
  connect_bd_net -net axi_Z7_ProcHDMI_0_hdmi_TMDS_Clk_p [get_bd_ports hdmi_TMDS_Clk_p] [get_bd_pins axi_Z7_ProcHDMI_0/hdmi_TMDS_Clk_p]
  connect_bd_net -net axi_Z7_ProcHDMI_0_hdmi_TMDS_Data_n [get_bd_ports hdmi_TMDS_Data_n] [get_bd_pins axi_Z7_ProcHDMI_0/hdmi_TMDS_Data_n]
  connect_bd_net -net axi_Z7_ProcHDMI_0_hdmi_TMDS_Data_p [get_bd_ports hdmi_TMDS_Data_p] [get_bd_pins axi_Z7_ProcHDMI_0/hdmi_TMDS_Data_p]
  connect_bd_net -net axi_Z7_ProcHDMI_0_led [get_bd_ports led] [get_bd_pins axi_Z7_ProcHDMI_0/led]
  connect_bd_net -net btn_1 [get_bd_ports btn] [get_bd_pins axi_Z7_ProcHDMI_0/btn]
  connect_bd_net -net clk_wiz_0_clk_hdmi [get_bd_pins axi_Z7_ProcHDMI_0/clk_hdmi] [get_bd_pins clk_wiz_0/clk_hdmi]
  connect_bd_net -net clk_wiz_0_clk_vga [get_bd_pins axi_Z7_ProcHDMI_0/clk_display] [get_bd_pins clk_wiz_0/clk_vga]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_Z7_ProcHDMI_0/s00_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net processing_system7_1_FCLK_CLK0 [get_bd_pins axi_Z7_ProcHDMI_0/s00_axi_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_1/FCLK_CLK0] [get_bd_pins processing_system7_1/M_AXI_GP0_ACLK] [get_bd_pins smartconnect_0/aclk]
  ...
  connect_bd_net -net sw_1 [get_bd_ports sw] [get_bd_pins axi_Z7_ProcHDMI_0/sw]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00400000 -target_address_space [get_bd_addr_spaces processing_system7_1/Data] [get_bd_addr_segs axi_Z7_ProcHDMI_0/s00_axi/reg0] -force
