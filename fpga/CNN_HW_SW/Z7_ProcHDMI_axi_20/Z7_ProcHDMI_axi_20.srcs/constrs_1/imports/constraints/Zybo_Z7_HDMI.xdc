...
##HDMI TX
set_property -dict { PACKAGE_PIN H16 IOSTANDARD LVCMOS33 } [get_ports { hdmi_TMDS_Clk_p }]
set_property -dict { PACKAGE_PIN H17 IOSTANDARD LVCMOS33 } [get_ports { hdmi_TMDS_Clk_n }]
# Data 0
set_property -dict { PACKAGE_PIN D19 IOSTANDARD LVCMOS33 } [get_ports { hdmi_TMDS_Data_p[0] }]
set_property -dict { PACKAGE_PIN D20 IOSTANDARD LVCMOS33 } [get_ports { hdmi_TMDS_Data_n[0] }]
# Data 1
set_property -dict { PACKAGE_PIN C20 IOSTANDARD LVCMOS33 } [get_ports { hdmi_TMDS_Data_p[1] }]
set_property -dict { PACKAGE_PIN B20 IOSTANDARD LVCMOS33 } [get_ports { hdmi_TMDS_Data_n[1] }]
# Data 2
set_property -dict { PACKAGE_PIN B19 IOSTANDARD LVCMOS33 } [get_ports { hdmi_TMDS_Data_p[2] }]
set_property -dict { PACKAGE_PIN A20 IOSTANDARD LVCMOS33 } [get_ports { hdmi_TMDS_Data_n[2] }]
