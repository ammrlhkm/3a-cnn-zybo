...
xv_boost_lib_path=/softslin/vivado_20.2/Vivado/2020.2/tps/boost_1_64_0
...
{
  file="xsim.ini"
  lib_map_path="/softl2/XILINX/vivado_20.2/Vivado/2020.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
map_local_libs()
{
  ...
  local_libs=(xil_defaultlib blk_mem_gen_v8_4_4 blk_mem_gen_v8_3_6)
