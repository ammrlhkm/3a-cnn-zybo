...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set D_PHY_CLK_N [ create_bd_port -dir I -type clk D_PHY_CLK_N ]
  set D_PHY_CLK_P [ create_bd_port -dir I -type clk D_PHY_CLK_P ]
  set D_PHY_DATA_N [ create_bd_port -dir I -from 0 -to 1 D_PHY_DATA_N ]
  set D_PHY_DATA_P [ create_bd_port -dir I -from 0 -to 1 D_PHY_DATA_P ]
  set D_PHY_LP_CLK_N [ create_bd_port -dir I -type clk D_PHY_LP_CLK_N ]
  set D_PHY_LP_CLK_P [ create_bd_port -dir I -type clk D_PHY_LP_CLK_P ]
  set D_PHY_LP_DATA_N [ create_bd_port -dir I -from 0 -to 1 D_PHY_LP_DATA_N ]
  set D_PHY_LP_DATA_P [ create_bd_port -dir I -from 0 -to 1 D_PHY_LP_DATA_P ]
  set btn [ create_bd_port -dir I -from 3 -to 0 btn ]
  set cam_clk [ create_bd_port -dir O -from 0 -to 0 -type data cam_clk ]
  set cam_gpio [ create_bd_port -dir O -from 0 -to 0 -type data cam_gpio ]
  ...
  # Create instance: MC_HDMI_proc_0, and set properties
  set MC_HDMI_proc_0 [ create_bd_cell -type ip -vlnv cime3:user:MC_HDMI_proc:1.0 MC_HDMI_proc_0 ]
  ...
  connect_bd_intf_net -intf_net processing_system7_1_IIC_0 [get_bd_intf_ports cam_iic] [get_bd_intf_pins processing_system7_1/IIC_0]

  # Create port connections
  connect_bd_net -net D_PHY_CLK_N_1 [get_bd_ports D_PHY_CLK_N] [get_bd_pins MC_HDMI_proc_0/D_PHY_CLK_N]
  connect_bd_net -net D_PHY_CLK_P_1 [get_bd_ports D_PHY_CLK_P] [get_bd_pins MC_HDMI_proc_0/D_PHY_CLK_P]
  connect_bd_net -net D_PHY_DATA_N_1 [get_bd_ports D_PHY_DATA_N] [get_bd_pins MC_HDMI_proc_0/D_PHY_DATA_N]
  connect_bd_net -net D_PHY_DATA_P_1 [get_bd_ports D_PHY_DATA_P] [get_bd_pins MC_HDMI_proc_0/D_PHY_DATA_P]
  connect_bd_net -net D_PHY_LP_CLK_N_1 [get_bd_ports D_PHY_LP_CLK_N] [get_bd_pins MC_HDMI_proc_0/D_PHY_LP_CLK_N]
  connect_bd_net -net D_PHY_LP_CLK_P_1 [get_bd_ports D_PHY_LP_CLK_P] [get_bd_pins MC_HDMI_proc_0/D_PHY_LP_CLK_P]
  connect_bd_net -net D_PHY_LP_DATA_N_1 [get_bd_ports D_PHY_LP_DATA_N] [get_bd_pins MC_HDMI_proc_0/D_PHY_LP_DATA_N]
  connect_bd_net -net D_PHY_LP_DATA_P_1 [get_bd_ports D_PHY_LP_DATA_P] [get_bd_pins MC_HDMI_proc_0/D_PHY_LP_DATA_P]
  connect_bd_net -net MC_HDMI_proc_0_hdmi_TMDS_Clk_n [get_bd_ports hdmi_TMDS_Clk_n] [get_bd_pins MC_HDMI_proc_0/hdmi_TMDS_Clk_n]
  connect_bd_net -net MC_HDMI_proc_0_hdmi_TMDS_Clk_p [get_bd_ports hdmi_TMDS_Clk_p] [get_bd_pins MC_HDMI_proc_0/hdmi_TMDS_Clk_p]
  connect_bd_net -net MC_HDMI_proc_0_hdmi_TMDS_Data_n [get_bd_ports hdmi_TMDS_Data_n] [get_bd_pins MC_HDMI_proc_0/hdmi_TMDS_Data_n]
  connect_bd_net -net MC_HDMI_proc_0_hdmi_TMDS_Data_p [get_bd_ports hdmi_TMDS_Data_p] [get_bd_pins MC_HDMI_proc_0/hdmi_TMDS_Data_p]
  connect_bd_net -net MC_HDMI_proc_0_led [get_bd_ports led] [get_bd_pins MC_HDMI_proc_0/led]
  connect_bd_net -net btn_1 [get_bd_ports btn] [get_bd_pins MC_HDMI_proc_0/btn]
  connect_bd_net -net clk_in1_1 [get_bd_ports pl_clk] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net clk_wiz_0_clk_camera [get_bd_pins MC_HDMI_proc_0/clk_camera] [get_bd_pins clk_wiz_0/clk_camera]
  connect_bd_net -net clk_wiz_0_clk_hdmi [get_bd_pins MC_HDMI_proc_0/clk_hdmi] [get_bd_pins clk_wiz_0/clk_hdmi]
  connect_bd_net -net clk_wiz_0_clk_vga [get_bd_pins MC_HDMI_proc_0/clk_display] [get_bd_pins clk_wiz_0/clk_vga]
  connect_bd_net -net sw_1 [get_bd_ports sw] [get_bd_pins MC_HDMI_proc_0/sw]
  connect_bd_net -net xlconstant_0_dout [get_bd_ports cam_clk] [get_bd_ports cam_gpio] [get_bd_pins xlconstant_0/dout]
