...
//  
//  Running on Linux smancini@ocaepc44 3.16.0-4-amd64 x86_64 aol
//  
...
options set Input/SearchPath /usr/include/x86_64-linux-gnu
...
solution file add ./ImgProcParamTest.cpp -type C++
...
go new
directive set -DESIGN_HIERARCHY ImgProcParamTest
go compile
solution options set /Flows/Precision/addio false
...
go assembly
directive set /ImgProcParamTest/ctrl:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /ImgProcParamTest/avg:rsc -MAP_TO_MODULE mgc_ioport.mgc_out_reg
go architect
go extract
