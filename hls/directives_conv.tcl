...
solution file add ../include/conv_fixed.h -type CHEADER
solution file add ../src/preprocess_image.cpp -type C++ -exclude true
solution file add ../src/conv_fixed.cpp -type C++
solution file add ../src/conv_scverify_bench.cpp -type C++ -exclude true
go analyze
solution design set edge_detection -top
go compile
