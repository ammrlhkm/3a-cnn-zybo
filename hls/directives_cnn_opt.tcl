...
//
project new -name Catapult_CNN -dir ./Catapult_CNN
...
directive set /cnn_hardware_opt -START_FLAG start
directive set /cnn_hardware_opt -READY_FLAG ready
directive set /cnn_hardware_opt -DONE_FLAG done
go assembly
directive set /cnn_hardware_opt/image_in:rsc -MAP_TO_MODULE {Xilinx_RAMS.BLOCK_1R1W_RBW_DUAL suppress_sim_read_addr_range_errs=1}
directive set /cnn_hardware_opt/prob_out:rsc -MAP_TO_MODULE {Xilinx_RAMS.BLOCK_1R1W_RBW_DUAL suppress_sim_read_addr_range_errs=1}
directive set /cnn_hardware_opt/prob_out -WORD_WIDTH 10
go architect
go allocate
go extract
